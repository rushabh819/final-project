...
def load_indicator(filepath, value_name):
    ...
    # Identifing year columns (numeric column names)
    year_cols = [col for col in df.columns if col.isdigit()]
    # Melting data from wide (years as columns) to long format
    df_long = df.melt(
...
def main():
    ...
    gdp_file = "data/raw/API_NY.GDP.PCAP.CD_DS2_en_csv_v2_19346.csv"
    life_file = "data/raw/API_SP.DYN.LE00.IN_DS2_en_csv_v2_19383.csv"
